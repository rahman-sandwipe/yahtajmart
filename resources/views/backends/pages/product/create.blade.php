    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <form method="post" action="{{ route('product.create') }}" enctype="multipart/form-data" class="row">
                            @csrf
                            <!-- Title -->
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" name="width_or_size" id="width_or_sizeINPUT" class="form-control @error('width_or_size') is-invalid @enderror" placeholder="kg/cm" required>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" name="total_stock" id="total_stockINPUT" class="form-control @error('total_stock') is-invalid @enderror" placeholder="Type..." required>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" name="regular_price" id="regular_priceINPUT" class="form-control @error('regular_price') is-invalid @enderror" placeholder="Type..." required>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" name="offer_price" id="offer_priceINPUT" class="form-control @error('offer_price') is-invalid @enderror" placeholder="Type..." required>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" name="total_discount" id="total_discountINPUT" class="form-control @error('total_discount') is-invalid @enderror" placeholder="Type..." required>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="s_tags" id="s_tagsINPUT" class="form-control @error('s_tags') is-invalid @enderror" placeholder="Type...">
                            </div>
                            <!-- Sort Description -->
                            <div class="form-group col-12">
                                <label for="sort_descINPUT">Sort Description <sup class="text-danger">*</sup></label>
                                <textarea name="sort_desc" id="sort_descINPUT" rows="3" class="form-control summernote" required></textarea>
                            </div>
                            <!-- Description -->
                            <div class="form-group col-12">
                                <label for="descriptionINPUT">Description</label>
                                <textarea name="description" id="descriptionINPUT" rows="3" class="form-control summernote"></textarea>
                            </div>
                            <!-- Aditional Info -->
                            <div class="form-group col-12">
                                <label for="aditional_infoINPUT">Aditional Info</label>
                                <textarea name="aditional_info" id="aditional_infoINPUT" rows="3" class="form-control summernote"></textarea>
                            </div>
                            {{-- Meta Tags & Meta Desc --}}
                            <div class="form-group col-6">
