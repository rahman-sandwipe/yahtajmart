                    ...
                    <div class="card bg-body-tertiary border-0 auth-card">
                        <div class="auth-card__header card-header bg-body-tertiary border-0 p-5 pb-0">
                            <div class="d-flex flex-column align-items-center">
                                <img src="{{ asset($settings->web_logo) }}" width="200">
                            </div>
                        </div>
                        <div class="auth-card__body card-body p-5 pt-3">
                            <form method="POST" action="{{ route('user.login') }}" class="js-base-form dirty-check"> @csrf
                                <div class="mb-3">
                                    <input class="form-control" name="email" type="email" id="email" data-counter="60" placeholder="Your email" required>
                                </div>
                                <div class="mb-3">
                                    <input type=password name=password class="form-control" data-counter="30" placeholder="Password">
                                </div>
