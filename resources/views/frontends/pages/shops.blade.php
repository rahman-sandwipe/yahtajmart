        ...
        <div class="container">
            <div class="breadcrumb">
                <a href="{{ route('home') }}" rel='nofollow'>
                    <i class="fi-rs-home mr-5"></i><samp>Home</samp>
                </a>
                <span></span>
                <samp>Shops</samp>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="shop-product-fillter">
                    ...
                    <div class="sort-by-product-area mt-10">
                            ...
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ route('product_details',$item->slug) }}">
                                        <img class="default-img" src="{{ asset($item->thumb) }}" alt="" />
                                        <img class="hover-img" src="{{ asset($item->thumb) }}" alt="" />
                                    </a>
                                </div>
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        ...
                                        <span class="old-price">{{ $item->regular_price }} BDT</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class='add' href="{{ route('addToCart',$item->id) }}"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                                </div>
                            </div>
                        </div>
